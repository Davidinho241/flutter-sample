...
double defaultScreenWidth = 1080;
double defaultScreenHeight = 1920;
...
class Sizes {
  ...
  static double s173 = 173.0;
  static double s180 = 180.0;
  static double s185 = 185.0;
  ...
  static Future setScreenAwareConstant(context) async {
    ...
    s31m25 = ScreenUtil().setWidth(31.25);
    ...
    s185 = ScreenUtil().setWidth(185.0);
